...
import { 
  ...
  Clock, LogOut, LayoutGrid, KeyRound, LayoutTemplate
} from "lucide-react";
...
const adminLinks = [
  ...
  { href: "/admin/layanan", label: "Layanan Masjid", icon: LayoutGrid },
  { href: "/admin/berita", label: "Berita & Artikel", icon: Newspaper },
  { href: "/admin/kegiatan", label: "Kegiatan Masjid", icon: Calendar },
