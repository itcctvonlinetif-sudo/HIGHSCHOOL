...
interface AccessForm {
  ...
  classesAccessTimeoutMinutes: number;
  hasPassword: boolean;
}
    ...
    fetch(`${BASE}/api/admin/classes-access`, { credentials: "include" })
      ...
      .then((data) => {
        ...
        setAccessForm({
          ...
          classesAccessPassword: "",
          classesAccessTimeoutMinutes: Math.min(10, Math.max(1, Number(data.classesAccessTimeoutMinutes) || 3)),
  ...
  const handleSaveAccess = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      const body: Record<string, string> = {
        ...
        classesAccessTimeoutMinutes: String(accessForm.classesAccessTimeoutMinutes),
      };
