...
const DEFAULT_SETTINGS = {
  ...
  description: "Zein Page adalah pusat informasi dan layanan komunitas yang menghadirkan kegiatan, berita, dan layanan untuk masyarakat.",
  address: "Jl. Taman Wijaya Kusuma, Jakarta Pusat 10710",
  phone: "(021) 3811493",
  email: "info@zeinpage.id",
  facebook: "https://www.facebook.com/zeinpage",
  twitter: null,
  instagram: "https://www.instagram.com/zeinpage",
  youtube: "https://www.youtube.com/@zeinpage",
  logoUrl: null,
  heroImageUrl: null,
  heroTitle: "Selamat Datang di Zein Page",
